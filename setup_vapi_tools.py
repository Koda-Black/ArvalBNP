"""
Setup Vapi Tools for Arval Voice Agent
...
TOOLS = [
    {
        ...
        "messages": [
            ...
            },
            {
                ...
                "content": "I've scheduled your {{appointment_type}} appointment for {{preferred_date}} in the {{preferred_time}} slot. You'll receive a confirmation shortly."
            },
            {
                "type": "request-failed",
    ...
    },
    {
        ...
        "messages": [
            ...
            {
                "type": "request-complete",
                "content": "Thank you {{contact_name}}! I've recorded your interest and one of our fleet specialists will be in touch with you shortly."
            },
            {
                "type": "request-failed",
    ...
    },
    {
        ...
        "messages": [
            ...
            {
                "type": "request-complete",
                "content": "I've scheduled a callback for you, {{customer_name}}. One of our team members will call you back during {{preferred_time}}."
            },
            {
                "type": "request-failed",
    ...
    },
    {
        ...
        "messages": [
            ...
            {
                "type": "request-complete",
                "content": "Based on your question about {{topic}}, here's what I can tell you..."
            }
        ]
    }
]

def update_assistant_with_tools():
    ...
    payload = {
        "model": {
            ...
            "model": "openai/gpt-4o",
            "tools": TOOLS,
            "toolIds": []  # Clear any existing tool IDs
        }
    }
